      ...
      <aside class="el-aside border-right">
        <router-link v-for="(menu, key) in menus" :to="menu.path" :key="key">
          <div
            ...
            class="menu pointer"
            :class="{
              selectd: $route.fullPath == menu.path
            }"
          >
            <div class="icon">
          ...
          <div class="tips" v-if="menu.tips">
            <n-tag
              size="small"
              :bordered="false"
              :type="$route.fullPath == menu.path ? 'success' : 'info'"
              :style="$route.fullPath == menu.path ? 'background-color: rgba(255,255,255,0.25); color: #fff' : ''"
            >
              {{ menu.tips }}
            </n-tag>
          </div>
