...
<template>
  <div class="talk pointer" :class="{ actived: active }" @click="emit('tab-talk', data)">
    <div class="avatar-box">
      ...
      <div class="top-mask" @click.stop="emit('top-talk', data)" v-if="!data.is_robot">
    ...
    <div class="content-box">
      <div class="header">
        <div class="title">
          ...
          <span class="badge tip" v-show="Number(data.service_amount) > Number(userStore.amount_line)">T</span>
          <span class="badge group" v-show="data.talk_type == 2">群</span>
          <span class="badge top" v-show="data.is_v2">v2</span>
        </div>
...
.badge {
  ...
  &.tip {
    color: #fff !important;
    background-color:  rgb(220, 101, 10)  !important;
  }
