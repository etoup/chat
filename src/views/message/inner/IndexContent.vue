...
import { useUserStore, useDialogueStore, useUploadsStore, useCaseDetailStore } from '@/store'
...
import { ServeProgressItemSelect } from '@/api/user'
...
const events = {
  ...
  caseDetail: () => {
    caseDetailStore.setVisible(true)
  }
}
...
<template>
  <section id="drawer-container" class="el-container is-vertical">
    ...
    <header class="el-header bdr-b">
      <PanelHeader
        ...
        :num="talkParams.num"
        :status="dialogueStore.talk.case_status"
        :options="options"
  ...
  <CaseDetail v-model:visible="caseDetailStore.visible" :gid="talkParams.receiver_id" />
</template>
