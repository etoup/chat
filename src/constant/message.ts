...
export const ChatMsgTypeConfirmCard = 14 // 自定义消息
export const ChatMsgTypePaymentCard = 15 // 支付卡片消息
export const ChatMsgTypeMention = 16 // 提示消息
export const ChatMsgTypeWarning = 17 // 预警消息
...
export const ChatMsgTypeMapping = {
  ...
  [ChatMsgTypeMention]: '[提示消息]',
  [ChatMsgTypeWarning]: '[预警消息]',
  [ChatMsgTypeVote]: '[投票消息]',
  [ChatMsgTypeCode]: '[代码消息]',
  [ChatMsgTypeMixed]: '[图文消息]',
  [ChatMsgTypeGroupNotice]: '[群公告]',
  [ChatMsgTypeConfirmCard]: '[自定义消息]',
  [ChatMsgTypePaymentCard]: '[支付卡片消息]',
  [ChatMsgSysText]: '[系统消息]',
...
export const MessageComponents = {
  ...
  [ChatMsgTypeMention]: 'mention-message',
  [ChatMsgTypeWarning]: 'warning-message',
  ...
  [ChatMsgTypeConfirmCard]: 'confirm-card-message',
  [ChatMsgTypePaymentCard]: 'payment-card-message',
