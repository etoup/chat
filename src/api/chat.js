...
export const ServeTalkSearchList = (data = {}) => {
  return post('/api/v1/talk/searchList', data)
}

export const ServeFindTalkContentRecords = (data = {}) => {
  return get('/api/v1/talk/records/content', data)
}

export const ServeFindTalkInformationRecords = (data = {}) => {
  return get('/api/v1/talk/records/information', data)
}
...
// 标记聊天消息未读数服务接口
export const ServeMarkTalkUnreadNum = (data = {}) => {
  return post('/api/v1/talk/unread/mark', data)
}

// 清除全部聊天消息未读数服务接口
export const ServeClearAllTalkUnreadNum = (data = {}) => {
  return post('/api/v1/talk/unread/clear/all', data)
}
...
export const ServeVoiceTranslate = (data = {}) => {
  return post('/api/v1/upload/file/voiceUrl', data)
}
