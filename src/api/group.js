...
// 获取群组列表
export const ServeGetGroupList = (data) => {
  return get('/api/v1/group/sort/list', data)
}

// 群组分组新增更新

export const ServeGetGroupSave = (data) => {
  return post('/api/v1/group/sort/save', data)
}

// 群组分组删除
export const ServeGetGroupDelete = (data) => {
  return post('/api/v1/group/sort/remove', data)
}

export const ServeGetGroupSortSelect = (data) => {
  return get('/api/v1/group/sort/select', data)
}

export const ServeGetGroupSortSet = (data) => {
  return post('/api/v1/group/sortSet', data)
}

export const ServeGetGroupSortCancel = (data) => {
  return post('/api/v1/group/sortCancel', data)
}

export const ServeGetGroupSortGroupSave = (data) => {
  return post('/api/v1/group/sortGroupList', data)
}

export const ServeUpdateGroupLabel = (data) => {
  return post('/api/v1/group/member/label', data)
}
