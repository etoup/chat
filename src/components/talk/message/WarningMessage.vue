...
<template>
  <section class="im-message-mention" @click="onToTalk(data)">
    <h4 :class="data.is_open === 1 ? 'page-color-green' : 'page-color-red'">预警通知</h4>
    <p class="page-color-blue">时间：{{ extra.datetime }} (CST)</p>
    <p v-if="extra.type === 2">提示：<span class="page-weight">{{ extra.name }}</span></p>
