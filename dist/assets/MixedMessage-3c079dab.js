import{t as f}from"./emojis-0ead063f.js";import{t as g}from"./strings-8042df5b.js";import{g as u}from"./functions-9be2054c.js";import{t as b,bJ as s,bK as r,bL as d,bX as n,ae as a,bU as y,bM as o,e1 as M,bs as k,bR as v,bN as w,bS as N}from"./index-e4844543.js";import{a as L}from"./Image-d6077573.js";const I=["innerHTML"],V=b({__name:"MixedMessage",props:{extra:{},data:{},maxWidth:{}},setup(l){const p=l.data.float,m=(i,e=200)=>{const t=u(i);if(t.width==0||t.height==0)return{};if(t.width<e)return{width:`${t.width}px`,height:`${t.height}px`};let x=t.height/(t.width/e);return{width:e+"px",height:x+"px"}};return(i,e)=>(s(),r("div",{class:w(["im-message-mixed",{left:o(p)=="left",right:o(p)=="right",maxwidth:i.maxWidth}])},[d("pre",null,[e[8]||(e[8]=n("      ")),(s(!0),r(a,null,y(i.extra.items,t=>(s(),r(a,{key:t.id},[e[6]||(e[6]=n(`
        ...
        `))],64)):v("",!0),e[7]||(e[7]=n(`
      `))],64))),128)),e[9]||(e[9]=n(`
    `))])],2))}});const E=N(V,[["__scopeId","data-v-90737924"]]);export{E as default};
