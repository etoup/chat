import{t as U,r as _,u as ut,v as vt,y as d,A as ye,dM as ht,dN as ee,dO as gt,ar as xt,F as Pe,aR as mt,p as Z,aP as yt,ae as wt,N as St,H as Ct,aS as Rt,ax as Tt,J as r,L as i,M as S,K as T,O as $t,R as zt,Q as We,aA as we,b3 as ne,az as Pt,C as oe,w as Wt,$ as At,V as j,dP as Et,a9 as Lt,Z as I,_ as J,a1 as _t,a2 as Se,b8 as ie,dQ as Bt,at as Q,Y as kt,x as se,aI as jt,D as It,aj as Ht,ba as Ot}from"./index-6e6ef021.js";const Ft=ye(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[ye("&::-webkit-scrollbar",{width:0,height:0})]),Mt=U({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=_(null);function n(c){!(c.currentTarget.offsetWidth<c.currentTarget.scrollWidth)||c.deltaY===0||(c.currentTarget.scrollLeft+=c.deltaY+c.deltaX,c.preventDefault())}const s=ut();return Ft.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:vt,ssr:s}),Object.assign({selfRef:e,handleWheel:n},{scrollTo(...c){var m;(m=e.value)===null||m===void 0||m.scrollTo(...c)}})},render(){return d("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var Nt=/\s/;function Dt(e){for(var n=e.length;n--&&Nt.test(e.charAt(n)););return n}var Vt=/^\s+/;function Xt(e){return e&&e.slice(0,Dt(e)+1).replace(Vt,"")}var Ce=0/0,Ut=/^[-+]0x[0-9a-f]+$/i,Gt=/^0b[01]+$/i,Yt=/^0o[0-7]+$/i,Kt=parseInt;function Re(e){if(typeof e=="number")return e;if(ht(e))return Ce;if(ee(e)){var n=typeof e.valueOf=="function"?e.valueOf():e;e=ee(n)?n+"":n}if(typeof e!="string")return e===0?e:+e;e=Xt(e);var s=Gt.test(e);return s||Yt.test(e)?Kt(e.slice(2),s?2:8):Ut.test(e)?Ce:+e}var qt=function(){return gt.Date.now()};const le=qt;var Jt="Expected a function",Qt=Math.max,Zt=Math.min;function ea(e,n,s){var u,c,m,v,f,x,h=0,g=!1,A=!1,E=!0;if(typeof e!="function")throw new TypeError(Jt);n=Re(n)||0,ee(s)&&(g=!!s.leading,A="maxWait"in s,m=A?Qt(Re(s.maxWait)||0,n):m,E="trailing"in s?!!s.trailing:E);function y(b){var R=u,F=c;return u=c=void 0,h=b,v=e.apply(F,R),v}function $(b){return h=b,f=setTimeout(W,n),g?y(b):v}function C(b){var R=b-x,F=b-h,G=n-R;return A?Zt(G,m-F):G}function P(b){var R=b-x,F=b-h;return x===void 0||R>=n||R<0||A&&F>=m}function W(){var b=le();if(P(b))return z(b);f=setTimeout(W,C(b))}function z(b){return f=void 0,E&&u?y(b):(u=c=void 0,v)}function O(){f!==void 0&&clearTimeout(f),h=0,u=x=c=f=void 0}function L(){return f===void 0?v:z(le())}function p(){var b=le(),R=P(b);if(u=arguments,c=this,x=b,R){if(f===void 0)return $(x);if(A)return clearTimeout(f),f=setTimeout(W,n),y(x)}return f===void 0&&(f=setTimeout(W,n)),v}return p.cancel=O,p.flush=L,p}var ta="Expected a function";function de(e,n,s){var u=!0,c=!0;if(typeof e!="function")throw new TypeError(ta);return ee(s)&&(u="leading"in s?!!s.leading:u,c="trailing"in s?!!s.trailing:c),ea(e,n,{leading:u,maxWait:n,trailing:c})}const aa=U({name:"Add",render(){return d("svg",{width:"512",height:"512",viewBox:"0 0 512 512",fill:"none",xmlns:"http://www.w3.org/2000/svg"},d("path",{d:"M256 112V400M400 256H112",stroke:"currentColor","stroke-width":"32","stroke-linecap":"round","stroke-linejoin":"round"}))}}),fe=xt("n-tabs"),Ae={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]},sa=U({__TAB_PANE__:!0,name:"TabPane",alias:["TabPanel"],props:Ae,slots:Object,setup(e){const n=Pe(fe,null);return n||mt("tab-pane","`n-tab-pane` must be placed inside `n-tabs`."),{style:n.paneStyleRef,class:n.paneClassRef,mergedClsPrefix:n.mergedClsPrefixRef}},render(){return d("div",{class:[`${this.mergedClsPrefix}-tab-pane`,this.class],style:this.style},this.$slots)}}),ra=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},Tt(Ae,["displayDirective"])),be=U({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:ra,setup(e){const{mergedClsPrefixRef:n,valueRef:s,typeRef:u,closableRef:c,tabStyleRef:m,addTabStyleRef:v,tabClassRef:f,addTabClassRef:x,tabChangeIdRef:h,onBeforeLeaveRef:g,triggerRef:A,handleAdd:E,activateTab:y,handleClose:$}=Pe(fe);return{trigger:A,mergedClosable:Z(()=>{if(e.internalAddable)return!1;const{closable:C}=e;return C===void 0?c.value:C}),style:m,addStyle:v,tabClass:f,addTabClass:x,clsPrefix:n,value:s,type:u,handleClose(C){C.stopPropagation(),!e.disabled&&$(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){E();return}const{name:C}=e,P=++h.id;if(C!==s.value){const{value:W}=g;W?Promise.resolve(W(e.name,s.value)).then(z=>{z&&h.id===P&&y(C)}):y(C)}}}},render(){const{internalAddable:e,clsPrefix:n,name:s,disabled:u,label:c,tab:m,value:v,mergedClosable:f,trigger:x,$slots:{default:h}}=this,g=c??m;return d("div",{class:`${n}-tabs-tab-wrapper`},this.internalLeftPadded?d("div",{class:`${n}-tabs-tab-pad`}):null,d("div",Object.assign({key:s,"data-name":s,"data-disabled":u?!0:void 0},yt({class:[`${n}-tabs-tab`,v===s&&`${n}-tabs-tab--active`,u&&`${n}-tabs-tab--disabled`,f&&`${n}-tabs-tab--closable`,e&&`${n}-tabs-tab--addable`,e?this.addTabClass:this.tabClass],onClick:x==="click"?this.activateTab:void 0,onMouseenter:x==="hover"?this.activateTab:void 0,style:e?this.addStyle:this.style},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),d("span",{class:`${n}-tabs-tab__label`},e?d(wt,null,d("div",{class:`${n}-tabs-tab__height-placeholder`}," "),d(St,{clsPrefix:n},{default:()=>d(aa,null)})):h?h():typeof g=="object"?g:Ct(g??s)),f&&this.type==="card"?d(Rt,{clsPrefix:n,class:`${n}-tabs-tab__close`,onClick:this.handleClose,disabled:u}):null))}}),na=r("tabs",`
